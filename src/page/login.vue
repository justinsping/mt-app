  ...
  <div class="page-login">
    ...
    <div class="login-panel">
      ...
      <div class="form">
        ...
        <el-button type="primary" class="btn-login" @click="clickSumbit">登录</el-button>
        <p class="reg">
          <span>还没有账号？</span>
        ...
        <div class="oauth-wrapper">
          ...
          <div class="oauth">
            <a class="oauth__link oauth__link--qq" href="/account/connect/tencent"></a>
            <a class="oauth__link oauth__link--weibo" href="/account/connect/sina"></a>
          </div>
        </div>
      </div>
    </div>
